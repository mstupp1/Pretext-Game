...
export const PASSAGES: string[] = [
  ...
  `In 1815, M. Charles-François-Bienvenu Myriel was Bishop of D. He was an old man of about seventy-five years of age; he had occupied the see of D. since 1806. Although this detail has no connection whatever with the real substance of what we are about to relate...`,
  ...
  `I have turned over various books written on the subject of education, and patiently observed the conduct of parents and the management of schools; but what has been the result?—a profound conviction that the neglected education of my fellow-creatures is the grand source of the misery I deplore.`,
  ...
  // Voltaire — Candide
  `In the country of Westphalia, in the castle of the most noble Baron of Thunder-ten-tronckh, lived a youth endowed by Nature with the most gentle character. His face was the expression of his soul. His judgment was quite honest and he was extremely simple-minded.`,
